...
class Player(GameSprite):
    def update(self):
          ...
          if keys_pressed[K_RIGHT] and self.rect.x < 625:
            self.rect.x += speed
    def fire(self):
        bullet = Bullet('plazma.png', self.rect.centerx, self.rect.top, 60, 60, -20)
        bullets.add(bullet)
          

player = Player('awar.png', 350, 430, 130, 65, 30)
